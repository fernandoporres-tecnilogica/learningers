...
(function() {
  ...
  Annotator = (function(_super) {
    ...
    Annotator.prototype._setupEditor = function() {
      ...
      element = this.editor.addField({
        type: 'input',
        id: 'annotator-link',
        label: _t('Link'),
        load: function(field, annotation) {
          if ((annotation.link_titles != null)) {
            return $(field).find('input').val(annotation.link_titles[0]);
          } else {
      ...
      if ((this.options.autocomplete != null)) {
        hidden = this.editor.addField({
          ...
          submit: function(field, annotation) {
            ...
            if ($(field).find('input').val() !== "") {
              return annotation.links.push($(field).find('input').val());
            }
          },
          load: function(field, annotation) {
            if ((annotation.links != null)) {
              return $(field).find('input').val(annotation.links[0]);
            } else {
              return $(field).find('input').val('');
            }
          }
        ...
        $(element).find('input').autocomplete({
          ...
          select: function(event, ui) {
            ...
            $(hidden).find('input').val(ui.item.value);
            return false;
          }
        });
      }
    ...
    Annotator.prototype.startViewerHideTimer = function() {
      if (!this.viewerHideTimer) {
        return this.viewerHideTimer = setTimeout(this.viewer.hide, 150);
      }
    };
  ...
  Annotator.Plugin.Store = (function(_super) {
    ...
    Store.prototype._dataFor = function(annotation) {
      ...
      replacer = function(key, value) {
        if (key === "highlights" || key === "_marginObject") {
          return void 0;
        } else {
          return value;
        }
      ...
      data = JSON.stringify(annotation, replacer);
      return data;
    };
