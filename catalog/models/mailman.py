...
class MailmanList(Resource):
    ...
    def get_admin_moderation_url(self):
        return '%s/admindb/%s/?adminpw=%s' % (self.main_url, self.listname,
                                              self.password)

    def subscribe(self, email, first_name=u'', last_name=u''):
        from email.Utils import formataddr

        url = '%s/admin/%s/members/add' % (self.main_url, self.listname)
    ...
    def unsubscribe(self, email):
        url = '%s/admin/%s/members/remove' % (self.main_url, self.listname)
    ...
    def get_all_members(self):
        url = '%s/admin/%s/members/list' % (self.main_url, self.listname)
    ...
    def user_subscribe(self, email, password, language='fr', first_name=u'', last_name=u''):
        ...
        url = '%s/subscribe/%s' % (self.main_url, self.listname)
