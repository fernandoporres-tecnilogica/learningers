...
recurrence.widget.Widget.prototype = {
    ...
    init_dom: function() {
        ...
        var label = recurrence.widget.e('div', {'class': 'rec-label'});
        var root = recurrence.widget.e(
        ...
        var validate = new recurrence.widget.OKButton(
            'OK', {        });
        control.appendChild(validate.elements.root);
...
recurrence.widget.OKButton = function(label, options) {
    this.init(label, options);
};
recurrence.widget.OKButton.prototype = {
    init: function(label, options) {
        this.label = label;
        this.options = options || {};
    ...
    init_dom: function() {
        ...
        var label = recurrence.widget.e(
            'span', {'class': 'recurrence-label'}, this.label);
        var root = recurrence.widget.e(
            'a', {'class': 'add-button ok-button', 'href': 'javascript:void(0)'},
            [plus, label]);
